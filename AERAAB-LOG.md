# اعراب کا کھاتہ — 26 اگست 2026

> ہر اعراب فاروق کے اپنے تصدیق شدہ رومن سے نکالا گیا۔ پروگرام نے ہر ایک کا ڈھانچہ اصل لفظ سے ملا کر جانچا؛ نہ ملنے پر لفظ خود بخود رد۔

## بیچ 2 — 65 الفاظ

| لفظ | رومن (سند) | اعراب | معنی |
|---|---|---|---|
| سانس | saans | **سانْس** | breath |
| داستان | dastan | **داسْتان** | epic tale; saga |
| چراغ | charagh | **چَراغ** | lamp |
| آفریدی | afreedi | **آفْرِیدی** | Afridi |
| اتحادی | ittihadi | **اِتِّحادی** | allied; of or pertaining to coalition; a |
| احباب | ahbab | **اَحْباب** | friends, companions, members |
| احتجاجی | ehtejaji | **اِحْتِجاجی** | protestor |
| اخبارات | akhbarat | **اَخْبارات** | press; plural of اخبار, newspapers |
| استقبال | istiqbal | **اِسْتِقْبال** | welcome, hail, reception |
| اصحاب | ashab | **اَصْحاب** | masters, lords |
| اطراف | atraf | **اَطْراف** | plural of طرف (taraf); vicinity |
| امتیاز | imtiyaz | **اِمْتِیاز** | a surname |
| بدولت | badaulat | **بَدَوْلَت** | through (someone), due to; by the grace  |
| برصغیر | barr-i sagheer | **بَرِّصَغِیر** | Indian subcontinent (a subcontinent in S |
| تذکرہ | tezkirah | **تَذْکِرَہ** | substantial |
| تنخواہ | tankhah | **تَنْخواہ** | salary |
| حکمت | hikmat | **حِکْمَت** | wisdom; knowledge; mystery |
| خطرناک | khatarnak | **خَطَرْناک** | dangerous |
| خودکش | khudkush | **خودْکُش** | suicidal; of or relating to suicide |
| دائرہ | daira | **دائِرَہ** | circumference, limit; extent, reach; cir |
| دباؤ | dabao | **دَباؤ** | weight; power; influence, control |
| دکھ | dukh | **دُکھ** | sadness, grief; suffering, distress; pai |
| ذخیرہ | zakherah | **ذَخِیرَہ** | storehouse; outhouse |
| رفتہ | rafta | **رَفْتَہ** | gone; departed; deceased |
| روزانہ | rozana | **روزانَہ** | daily; daily pay or allowance |
| رکاوٹ | rukavat | **رُکاوَٹ** | obstruction; barricade; stoppage |
| سائنسی | sainsi | **سائِنْسی** | scientific |
| سادہ | sada | **سادَہ** | plain, simple; white |
| سازش | sazish | **سازِش** | conspiracy, scheme, plot |
| سبھا | sabha | **سَبھا** | assembly, council; meeting; association |
| سرخ | surkh | **سُرْخ** | red; twilight-colored; a communist or so |
| سرمایہ | sarmaya | **سَرْمایَہ** | capital; wealth; financial means; materi |
| سرگرم | sargarm | **سَرْگَرْم** | active, working |
| سچائی | sachchai | **سَچّائی** | truth; reality; accuracy |
| سیاستدان | siyasatdan | **سِیاسَتْدان** | politician |
| سینٹر | sentar | **سینْٹَر** | centre, center |
| سینیٹر | seenetar | **سینیٹَر** | senator |
| صلاح | salah | **صَلاح** | advice, counsel |
| عارضی | arizi | **عارِضی** | temporary |
| علما | ulama | **عُلَما** | plural of عالم (ālim) |
| علوم | uloom | **عُلُوم** | plural of علم ('ilm) |
| فطرت | fitrat | **فِطْرَت** | disposition; temperament; nature |
| قیمتی | qeemti | **قِیمْتی** | valuable; precious; costly |
| لعنت | lanat | **لَعْنَت** | curse, anathema, imprecation |
| لڑکیوں | larkiyon | **لَڑْکِیوں** | oblique plural of لڑکی |
| لڑکے | larke | **لَڑْکے** | indirect singular of لڑکا; vocative sing |
| لگانا | lagana | **لَگانا** | to affix, attach, join; to place; instal |
| مبتلا | mubtalan | **مُبْتَلا** | afflicted |
| مدارس | madaris | **مَدارِس** | plural of مدرسہ (madrasa) |
| مزاج | mizaj | **مِزاج** | humor; temperament |
| معاشرہ | muashara | **مُعاشَرَہ** | society; community |
| مفت | muft | **مُفْت** | free of charge |
| میڈیکل | medikal | **میڈِیکَل** | medical |
| نشست | nashist | **نَشِسْت** | seat; session |
| نفاذ | nafaz | **نَفاذ** | enforcement; promulgation |
| نوکری | naukri | **نَوکْری** | job, employment, service |
| پتا | pata | **پَتا** | address (of a place); direction; father |
| ڈرامہ | drama | **ڈرامَہ** | drama; acting; play |
| کارڈ | kard | **کارْڈ** | card; credit card |
| کتابیں | kitaben | **کِتابیں** | direct plural of کِتاب (kitāb) |
| کرا | kara | **کَرا** | did, do |
| کشی | kashi | **کَشی** | decay |
